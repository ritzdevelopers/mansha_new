...
function SlideLayer({
  ...
  const animClass = entering
    ? direction === "next"
      ? "aagman-s3-card-in-next"
      : "aagman-s3-card-in-prev"
    : exiting
      ? direction === "next"
        ? "aagman-s3-card-out-next"
        : "aagman-s3-card-out-prev"
      : "";
...
function Styles() {
  return (
    <style jsx global>{`
      @keyframes aagman-s3-card-in-next {
        from {
      ...
      @keyframes aagman-s3-card-in-prev {
        from {
          transform: translateX(-100%);
        }
        to {
      ...
      @keyframes aagman-s3-card-out-next {
        from {
          transform: translateX(0);
        }
        to {
      ...
      @keyframes aagman-s3-card-out-prev {
        from {
          transform: translateX(0);
        }
        to {
      ...
      .aagman-s3-card-in-next {
        animation: aagman-s3-card-in-next 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
      }
      .aagman-s3-card-in-prev {
        animation: aagman-s3-card-in-prev 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
      }
      .aagman-s3-card-out-next {
        animation: aagman-s3-card-out-next 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
      }
      .aagman-s3-card-out-prev {
        animation: aagman-s3-card-out-prev 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
      }
