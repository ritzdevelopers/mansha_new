...
const signatureSlides = [
  { id: 1, title: "Signature Masterpieces 1", src: "/aagman/aagman-slider1.jpg" },
  { id: 2, title: "Signature Masterpieces 2", src: "/aagman/aagman-slider2.jpg" },
  { id: 3, title: "Signature Masterpieces 3", src: "/aagman/aagman-slider3.jpg" },
  { id: 4, title: "Signature Masterpieces 4", src: "/aagman/aagman-slider4.jpg" },
];
  ...
  return (
    <section ref={sectionRef} className="w-full bg-white px-0 ">
      ...
      <style jsx global>{`
        ...
        .aagman-s6-slide-next {
          animation: aagman-s6-clip-next 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
        }
        .aagman-s6-slide-next :is(img) {
          transform-origin: center center;
          animation: aagman-s6-img-zoom 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
        }
        .aagman-s6-slide-prev {
          animation: aagman-s6-clip-prev 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
        }
        .aagman-s6-slide-prev :is(img) {
          transform-origin: center center;
          animation: aagman-s6-img-zoom 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
        }
