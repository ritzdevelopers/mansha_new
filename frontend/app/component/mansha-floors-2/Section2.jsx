...
const GALLERY_IMAGES = [
  { src: "/delieved-gallery/floor1.jpg", alt: "Gallery image one" },
  { src: "/delieved-gallery/floor2.jpg", alt: "Gallery image two" },
  { src: "/delieved-gallery/floor3.jpg", alt: "Gallery image three" },
  { src: "/delieved-gallery/floor4.jpg", alt: "Gallery image four" },
  { src: "/delieved-gallery/floor5.jpg", alt: "Gallery image five" },
];
        ...
        <div className="mx-auto max-w-[1525px] px-5 sm:px-8 lg:px-[70px]">
          ...
          >
            <article className="gallery-card border border-[#E6E6E6] bg-white p-4">
              ...
              Timeless interiors that last
              </h3>
              <p className="mt-4 font-montserrat text-[16px] font-normal tracking-[0] text-[#00000099] md:leading-[25px] lg:leading-[28px]">
              These stunning residences, with their current and enduring styles, offer crisp and well-balanced interior design that stand the test of time with intricate detail.
              </p>
            </article>
