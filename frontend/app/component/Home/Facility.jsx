    ...
    <section className="w-full overflow-hidden bg-[#F8F8F8] ">
      <div className="mx-auto grid max-w-8xl grid-cols-1 gap-3 lg:gap-8 px-5 py-[35px] sm:px-8 lg:grid-cols-2 lg:items-start lg:px-[75px] lg:py-[70px] max-w-[1490px]">
        ...
        <div className="order-2 lg:order-2">
          <p ref={subtitleRef} className="max-w-[560px] font-['Optima','Optima_LT_Pro',Candara,'Segoe_UI',sans-serif] md:text-[25px] text-[22px] xl:text-[48px] lg:text-[44px] font-[500]  leading-[1.15] xl:leading-[55px] tracking-normal capitalize text-[#000000] lg:leading-[50px]">
