...
/** Official listing: https://share.google/pRgMJ95AO7xvI5GMW */
const LOCATION_MAP_EMBED =
  "https://maps.google.com/maps?q=Mansha%20Orchid%20Plot&t=m&z=15&output=embed&iwloc=near&hl=en_IN";
  ...
  return (
    <section className="w-full py-[35px] lg:py-[70px]">
      <div className="mx-auto max-w-[1525px] px-5 sm:px-8 lg:px-[70px]">
        ...
        From education to recreation, everything is placed within easy reach. 
        </p>
