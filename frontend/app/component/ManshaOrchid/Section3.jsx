...
function SlideLayer({
  ...
  const animClass = entering
    ? direction === "next"
      ? "orchid-s3-card-in-next"
      : "orchid-s3-card-in-prev"
    : exiting
      ? direction === "next"
        ? "orchid-s3-card-out-next"
        : "orchid-s3-card-out-prev"
      : "";
...
function Styles() {
  return (
    <style jsx global>{`
      @keyframes orchid-s3-card-in-next {
        from {
      ...
      @keyframes orchid-s3-card-in-prev {
        from {
          transform: translateX(-100%);
        }
        to {
      ...
      @keyframes orchid-s3-card-out-next {
        from {
          transform: translateX(0);
        }
        to {
      ...
      @keyframes orchid-s3-card-out-prev {
        from {
          transform: translateX(0);
        }
        to {
      ...
      .orchid-s3-card-in-next {
        animation: orchid-s3-card-in-next 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
      }
      .orchid-s3-card-in-prev {
        animation: orchid-s3-card-in-prev 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
      }
      .orchid-s3-card-out-next {
        animation: orchid-s3-card-out-next 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
      }
      .orchid-s3-card-out-prev {
        animation: orchid-s3-card-out-prev 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
      }
