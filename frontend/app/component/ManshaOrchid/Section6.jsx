...
const signatureSlides = [
  { id: 1, title: "Signature Masterpieces 1", src: "/orchid/slider1.jpg" },
  { id: 2, title: "Signature Masterpieces 2", src: "/orchid/slider2.jpg" },
  { id: 3, title: "Signature Masterpieces 3", src: "/orchid/slider3.jpg" },
  { id: 4, title: "Signature Masterpieces 4", src: "/orchid/slider4.jpg" },
];
  ...
  return (
    <section ref={sectionRef} className="w-full bg-white px-0 ">
      ...
      <style jsx global>{`
        ...
        .orchid-s6-slide-next {
          animation: orchid-s6-clip-next 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
        }
        .orchid-s6-slide-next :is(img) {
          transform-origin: center center;
          animation: orchid-s6-img-zoom 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
        }
        .orchid-s6-slide-prev {
          animation: orchid-s6-clip-prev 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
        }
        .orchid-s6-slide-prev :is(img) {
          transform-origin: center center;
          animation: orchid-s6-img-zoom 1.2s cubic-bezier(0.76, 0, 0.24, 1) forwards;
        }
