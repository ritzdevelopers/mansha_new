    ...
    open && mounted
      ? createPortal(
          ...
          >
            ...
            <div
              className="career-modal-panel relative flex max-h-[90vh] w-full overflow-hidden bg-white shadow-xl"
              style={modalStyle}
            ...
            >
              ...
              <div className="relative hidden min-h-[420px] w-[350px] shrink-0 overflow-hidden rounded-l-[15px] sm:block">
                <Image
                  src="/carrer/carrer-banner.jpg"
              ...
              <div className="flex max-h-[90vh] min-h-[420px] w-full flex-col overflow-hidden rounded-r-[15px] sm:w-[350px]">
                <div className="min-h-0 flex-1 overflow-y-auto px-6 pt-8 text-left sm:px-7 sm:pt-10 sm:pb-6">
                  ...
                  <h3
                    ...
                    className="mt-2 font-optima text-[15px] font-medium leading-[1.35] text-[#111111] md:text-[25px]"
                  >
                    {job.title}
                  </h3>
                  <p className="mt-2 font-montserrat text-[15px] font-normal leading-[1.65] tracking-wide text-[#64748b]">
