      ...
      <div className="mx-auto max-w-[1525px] px-5 sm:px-8 lg:px-[70px]">
        ...
        <div className="relative mt-8 lg:mt-14">
          <div className="flex flex-col md:items-center lg:flex-row lg:items-stretch">
            ...
            <div className="relative z-10 mxt-5 mx-auto w-full max-w-[400px] shrink-0 bg-white p-5 shadow-[0_8px_30px_rgba(0,0,0,0.12)] sm:p-6 md:mx-auto md:max-w-none md:w-full lg:mx-0 lg:mt-0 lg:max-w-[400px] lg:shrink-0 lg:-ml-16 lg:self-center xl:-ml-24">
              <div className="relative mb-4 flex justify-end">
                <span
                  className="inline-flex h-9 w-9 items-center justify-center "
                  aria-hidden
