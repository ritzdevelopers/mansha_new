        ...
        <div className="mx-auto max-w-[1525px] px-5 sm:px-8 lg:px-[70px]">
          ...
          >
            <article className="gallery-card border border-[#E6E6E6] bg-white p-4">
              ...
              Luxury defined by its uniqueness
              </h3>
              <p className="mt-4 font-montserrat text-[16px] font-normal tracking-[0] text-[#00000099] md:leading-[25px] lg:leading-[28px]">
              A fascinating look at these individually designed homes where comfort and style seamlessly blend with a refined sense of sophistication.
              </p>
            </article>
